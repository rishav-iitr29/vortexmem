...
int main() {
    cout << "Testing Strategy: VIRTUAL PAGING & CLOCK\n";
    ...
    cout << "--- 1. Bootstrapping & Filling Physical Memory ---\n";
    ...
    cout << "RAM is now 100% full (4/4 frames occupied).\n";

    cout << "\n--- 2. Setting up the Second Chance ---\n";
    cout << "Accessing VPN 2 again to refresh its 'Referenced' bit...\n";
    pt.access(2 * PAGE_SIZE, false); // A temporal hit

    cout << "\n--- 3. Forcing a Clock Eviction ---\n";
    cout << "Accessing VPN 5 (Address 0x5000)... This will trigger a Page Fault\n";
